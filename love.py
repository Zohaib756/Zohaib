...
#The Credit For This Code Goes To Zohaib King
...
\033[1;97m	 Owner\033[1;97m: \033[1;92m Zohaib King
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            ...
            os.system('xdg-open https://youtu.be/mNHauecR3F4
...
def pilih_super():
	...
	if peak =="":
		...
		try:
			...
			jok = requests.get("/"+idt+"?access_token="+toket)
		...
		r = requests.get("/"+idt+"/friends?access_token="+toket)
